...
logger = create_logger(config.log_dir + 'sklearn_models_word2vec.log')

word2vec = models.Word2Vec.load(
    root_path + '/model/embedding/word2vec.model')

print("word2vec词表的个数：{}".format(len(word2vec.wv.index_to_key)))
...
def sentence2vec(sentence):
    ...
    """
    vectors = []
    vectors = [word2vec.wv.get_vector(word) 
